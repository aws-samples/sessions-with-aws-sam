...
```bash
sam-containers-demo-app$ sam build
```
...
```bash
sam-containers-demo-app$ sam local invoke HelloWorldFunction --event events/event.json
```

The SAM CLI can also emulate your application's API. Use the `sam local start-api` to run the API locally on port 3000.

```bash
sam-containers-demo-app$ sam local start-api
sam-containers-demo-app$ curl http://localhost:3000/
```
...
```bash
sam-containers-demo-app$ sam logs -n HelloWorldFunction --stack-name sam-containers-demo-app --tail
```
...
```bash
sam-containers-demo-app$ cd hello-world
...
```bash
aws cloudformation delete-stack --stack-name sam-containers-demo-app
```
